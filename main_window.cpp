...
//    ui->cb_size_selection_2->addItems(size_list);
    ...
    QObject::connect(ui->pb_apply_1, &QPushButton::clicked, this, &MainWindow::onPbApply1);
    QObject::connect(ui->pb_launch_1, &QPushButton::clicked, this, &MainWindow::onPbLaunch1);
}

void MainWindow::onPbApply1() {
...
void MainWindow::setResultMatrixTable() {
...
void MainWindow::checkFillArray() {
